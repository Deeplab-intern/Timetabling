...
Public Class crpTimetable
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Timetable_Generator.crpTimetable.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpTimetable
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpTimetable = New crpTimetable()
        rpt.Site = Me.Site
        Return rpt
    End Function
